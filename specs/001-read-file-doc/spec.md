...
- **FR-012a**: When updating specific studies in studies.tsv or studies_derivatives.tsv, System MUST preserve existing entries for studies not being updated. Metadata generation MUST merge new/updated entries with existing entries rather than replacing the entire file. This ensures incremental updates do not cause data loss for unmodified studies.
