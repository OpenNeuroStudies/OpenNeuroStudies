...
- **FR-009**: System MUST generate studies.tsv with study_id, name, version, raw_version, bids_version, hed_version, license, authors, author_lead_raw, author_senior_raw, subjects_num, sessions_num, sessions_min, sessions_max, bold_num, t1w_num, t2w_num, bold_size, t1w_size, bold_size_max, bold_voxels, datatypes, derivative_ids, and bids_valid columns (where authors are from git shortlog of study dataset; author_lead_raw and author_senior_raw are first/last elements from Authors in raw dataset_description.json, using "n/a" if multiple sources with conflicting values, or duplicating if single author)
