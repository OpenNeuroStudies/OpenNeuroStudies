...
- **FR-003f**: System MUST sanitize all directory and submodule names by replacing sequences of non-alphanumeric characters (except hyphen and underscore) with a single `+` character. This applies to derivative directory names derived from tool names and versions (e.g., `qsiprep-1.0.1+gee9aa2e+d20250115` instead of `qsiprep-1.0.1.dev0+gee9aa2e.d20250115`).
